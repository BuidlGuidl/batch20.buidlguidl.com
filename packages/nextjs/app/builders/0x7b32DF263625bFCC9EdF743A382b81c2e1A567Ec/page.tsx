...
type SocialType = "github" | "x" | "portfolio";
...
const SOCIALS: Array<{
  ...
  { href: "https://github.com/Vk1033", label: "GitHub", handle: "Vk1033", type: "github" },
  { href: "https://x.com/0xVanqshr", label: "X", handle: "0xVanqshr", type: "x" },
  { href: "https://vk1033.vercel.app", label: "Portfolio", handle: "vk1033.vercel.app", type: "portfolio" },
];

const SocialIcon = ({ type }: { type: SocialType }) => {
  const cls = "w-5 h-5 text-zinc-700 dark:text-zinc-300 group-hover:text-zinc-900 dark:group-hover:text-zinc-100";
  switch (type) {
    case "github":
      return (
