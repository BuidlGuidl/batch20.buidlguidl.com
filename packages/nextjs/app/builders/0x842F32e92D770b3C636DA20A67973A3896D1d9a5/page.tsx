        ...
        <section className="md:col-span-1 space-y-6">
          <div className="rounded-2xl border border-cyan-500/30 shadow-lg shadow-cyan-500/10 p-6 bg-gray-100 dark:bg-gray-900/50 backdrop-blur-sm">
            <div className="flex flex-col items-center text-center">
              ...
              />
              <h1 className="text-2xl font-bold text-cyan-600 dark:text-cyan-300 mt-4">Isaac Netero</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">Batch #20 — Builder</p>
              <div className="mt-2">
                <Address address={ADDRESS} />
              </div>
              <p className="mt-4 text-gray-600 dark:text-gray-400">Freelancer from Vietnam 🇻🇳</p>
              <p className="mt-2 text-gray-600 dark:text-gray-400">Chainlink marine since 2020</p>
          ...
          <div className="rounded-2xl border border-cyan-500/30 shadow-lg shadow-cyan-500/10 p-6 bg-gray-100 dark:bg-gray-900/50 backdrop-blur-sm">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-cyan-500/20 p-4 bg-white dark:bg-gray-800/40 hover:bg-gray-200 dark:hover:bg-gray-800/70 transition-colors">
                <h3 className="font-semibold text-cyan-500 dark:text-cyan-400">🚩 Shafu-rs</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  A simple Rust crate for make Solidity code looks beautiful
                </p>
                <a
              ...
              <div className="rounded-lg border border-cyan-500/20 p-4 bg-white dark:bg-gray-800/40 hover:bg-gray-200 dark:hover:bg-gray-800/70 transition-colors">
                <h3 className="font-semibold text-cyan-500 dark:text-cyan-400">🚩 LINK staking bot</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-cyan-500/20 p-4 bg-white dark:bg-gray-800/40 hover:bg-gray-200 dark:hover:bg-gray-800/70 transition-colors">
                <h3 className="font-semibold text-cyan-500 dark:text-cyan-400">
                  🚩 Capture 12 Flags by solving 12 Solidity puzzles
                </h3>
                <a
